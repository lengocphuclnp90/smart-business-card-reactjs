...
class Card extends Component {
    ...
    async componentDidMount() {
        ...
        // let link = await `${uuidv4()}-${this.props.id}`;
        // this.setState({
        //     link: link,
        //     old_link: link,
        // }, async () => {
    ...
    reviewCard = () => {
        ...
        try {
            document.getElementById('cid').innerHTML = `CID: ${this.state.link}`;
        } catch (e) { }
        try {
            document.getElementById('name').innerHTML = `NAME: ${this.props.userInfo.name}`;
        } catch (e) { }
        try {
            ...
            <React.Fragment>
                                ...
                                <div className='form-info-content-card'>
                                    <div className='header-form-card'>
                                        {this.state.edit === true ?
                                            <React.Fragment>
                                                <div className='card-input-title'>Chỉnh sửa danh thiếp</div>
                                            </React.Fragment> :
                                            <React.Fragment>
                                                <div className='card-input-title'>Tạo danh thiếp mới</div>
                                            </React.Fragment>
                                        }
                                    ...
                                    <div className='body-form-card'>
                                        <div className='form-card-content'>
                                            <div className='card-sub-content-title'>
                                                <i class="far fa-address-card"></i> Kiểu danh thiếp:
                                            </div>
                                        ...
                                        <div className='form-card-content'>
                                            <div className='card-sub-content-title'>
                                                <i class="fas fa-pencil-alt"></i> Tên danh thiếp:
                                            </div>
                                            <div className='card-sub-content-input'>
                                                <input
                                        ...
                                        <div className='form-card-content'>
                                            ...
                                            <div className='card-sub-content-input'>
                                                ...
                                                >
                                                    <option value='S1'>Bất kì ai cũng xem được</option>
                                                    <option value='S2'>Người có tài khoản</option>
                                                    <option value='S3'>Gửi email yêu cầu phê duyệt xem</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className='right-box-content'>
                    <div className='right-header'>
                        <div className='right-table-title'>Danh thiếp hiện có</div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td className='table-title long'>Tên danh thiếp</td>
                                        <td className='table-title center very-small'>Số lượng</td>
                                        <td className='table-title center very-small'>Còn lại</td>
                                        <td className='table-title center small'>Bảo mật</td>
                                        <td className='table-title center medium'>Liên kết</td>
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    {(item.number - item.view) === 0 ?
                                                        <React.Fragment>
                                                            ...
                                                            <td className='table-content center very-small red'>Đã hết</td>
                                                        </React.Fragment> :
                                                        <React.Fragment>
                                                    ...
                                                    <td className='table-content center medium'>
                                                        <a href={`${path.BASE_URL}/card/${item.link}`} target='_blank'>Mở link <i class="fas fa-external-link-alt"></i></a>
                                                    </td>
                                                    <td className='table-content center medium'>
