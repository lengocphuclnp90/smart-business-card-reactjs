            ...
            <React.Fragment>
                ...
                <div className='right-box-content-list'>
                    <div className='right-header'>
                        <div className='right-table-title'>Danh Sách Mạng Xã Hội</div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListSocial));
