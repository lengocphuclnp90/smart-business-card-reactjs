            ...
            <React.Fragment>
                ...
                <div className='right-box-content-list'>
                    <div className='right-header'>
                        <div className='right-table-title'>Danh Sách Kênh Thanh Toán</div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListBank));
