...
class Email extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className='right-box-content-admin-email'>
                    <div className='right-header'>
                        <div className='header-title'><FormattedMessage id="info.email" /></div>
                        <div className='header-tool'>
                            ...
                            <div className='tool-content'>
                                <b><FormattedMessage id="info.emailF" /></b>
                                <div className='content-input'>
                                    <input className='filter-input' type='text'
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td className='table-title'><FormattedMessage id="info.email" /></td>
